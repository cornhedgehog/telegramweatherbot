...
var WeatherValues = []WeatherValue{WeatherValue{"ясно", "0"}, WeatherValue{"малооблачно", "1"}, WeatherValue{"облачно", "2"}, WeatherValue{"пасмурно", "3"}, WeatherValue{"дождь", "4"}, WeatherValue{"ливень", "5"}, WeatherValue{"небольшой снег", "6"}, WeatherValue{"сильный снег", "7"}, WeatherValue{"гроза", "8"}, WeatherValue{"нет данных", "9"}, WeatherValue{"без осадков", "10"}}
